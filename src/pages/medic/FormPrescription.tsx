...
const FormPrescription = () => {
  ...
  const [inputList, setInputList] = useState([{ medicine: "", morning: "", afternoon: "", evening: "", duration: "" }]);

  const handleAddClick = () => {
    setInputList([...inputList, { medicine: "", morning: "", afternoon: "", evening: "", duration: "" }])
  };
    ...
    <div className="col-md-8 col-sm-12" >
        <Card>
          <Form>
            ...
            <div className='row'>
            <div className='col-md-6 col-sm-12 prescriptionpadding'>
                <Input
